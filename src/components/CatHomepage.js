...
function CatHomepage({ isDarkMode }) {
  ...
  return (
    <div className={isDarkMode ? "homepage-container dark": "homepage-container"}>
      <h1 className={isDarkMode ? "homepage-header dark" : "homepage-header"}>You Are Purrfect</h1>
